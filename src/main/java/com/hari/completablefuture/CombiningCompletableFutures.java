package com.hari.completablefuture;
...
public class CombiningCompletableFutures {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		// we can use thenCompose and thenApply to wait until a completable is ready and
		// start with
		...
		// thenCombine offers the possibility to combine two completables that are
		// totally
		// independent
